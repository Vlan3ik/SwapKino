        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
              Бесплатный open-source сервис для поиска фильмов на вечер:
              каталог, рекомендации, оценки и социальные профили. Платных
              подписок нет; внешние рекламные и видеосервисы зависят от
              конфигурации проекта. Сделано с любовью к кино и открытому коду.
            </p>
            <a
