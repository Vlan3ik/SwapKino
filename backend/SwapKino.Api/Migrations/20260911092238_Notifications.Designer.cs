...
namespace SwapKino.Api.Migrations
{
    ...
    [Migration("20260911092238_Notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SwapKino.Api.CommentReaction", b =>
                {
            ...
            modelBuilder.Entity("SwapKino.Api.Filmstrip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapKino.Api.FilmstripFeature", b =>
                {
                    b.Property<Guid>("FilmstripId")
                        .HasColumnType("uuid");

                    b.Property<int>("FeatureType")
                        .HasColumnType("integer");

                    b.Property<int>("TmdbFeatureId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("FilmstripId", "FeatureType", "TmdbFeatureId");

                    b.ToTable("FilmstripFeatures");
                });

            modelBuilder.Entity("SwapKino.Api.FilmstripReference", b =>
                {
                    b.Property<Guid>("FilmstripId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("FilmstripId", "TmdbId", "IsSeries");

                    b.ToTable("FilmstripReferences");
                });

            modelBuilder.Entity("SwapKino.Api.Follow", b =>
                {
            ...
            modelBuilder.Entity("SwapKino.Api.KeywordAlias", b =>
                {
                    ...
                    b.ToTable("KeywordAliases");
                });

            modelBuilder.Entity("SwapKino.Api.MovieComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SwapKino.Api.RecommendationImpression", b =>
                {
                    ...
                    b.Property<string>("FeedItemType")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SwapKino.Api.UserTasteFeature", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "FeatureType", "TmdbFeatureId");

                    b.HasIndex("UserId", "Weight");

                    b.ToTable("UserTasteFeatures");
                });
            ...
            modelBuilder.Entity("SwapKino.Api.CommentReaction", b =>
                {
                    ...
                    b.HasOne("SwapKino.Api.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SwapKino.Api.FilmstripFeature", b =>
                {
                    b.HasOne("SwapKino.Api.Filmstrip", "Filmstrip")
                        .WithMany("Features")
            ...
            modelBuilder.Entity("SwapKino.Api.Follow", b =>
                {
                    b.HasOne("SwapKino.Api.User", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SwapKino.Api.User", "Following")
                        .WithMany()
            ...
            modelBuilder.Entity("SwapKino.Api.MovieComment", b =>
                {
                    b.HasOne("SwapKino.Api.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SwapKino.Api.MovieComment", "ParentComment")
                        .WithMany("Replies")
